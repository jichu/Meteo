    ...
    public class ForecastAreaParameters
    {
        ...
        */
        ...
        private float[][] windDirectioncoordinates =
            {
                    new float[] { 0f, 2f },//sever
                    new float[] { 1.42f, 1.42f},
                    new float[] { 2f, 0f },//východ
                    new float[] { 1.42f, -1.42f },
                    new float[] {  0f, -2f  },//jih
                    new float[] { -1.42f, -1.42f  },
                    new float[] { -2f, 0f },//západ
                    new float[] { -1.42f, 1.42f },
                };
        ...
        private void LoadParameters() {
            ...
            */
            ...
            //pro debug střihu větru
            /*Parameters.Add("Směr větru 1000 hPa", 0);
            Parameters.Add("Směr větru 850 hPa", 3);
            Parameters.Add("Směr větru 700 hPa", 1); 
            Parameters.Add("Směr větru 600 hPa", 2);
            Parameters.Add("Směr větru 500 hPa", 0); 
            Parameters.Add("Směr větru 400 hPa", 7); 
            Parameters.Add("Směr větru 300 hPa", 6);*/
            ...
            AddPrecipitationModel(new List<float>() { Parameters["Srážky ALADIN"], Parameters["Srážky WRF-NMM"], Parameters["Srážky WRF-ARW"]});
        }
        ...
        private bool TestConvection() {
            if (Parameters["MLCAPE + LI Conv"] < 0.5)
            {
                return false;
            }
            else {
